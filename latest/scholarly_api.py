    ...
    def coach(prompt, session=get_session(), image_path=None, stream=False, timeout=None):
      """
      ...
      def stream_response():
        with requests.post(url, timeout=timeout, files=files, stream=True) as response:
